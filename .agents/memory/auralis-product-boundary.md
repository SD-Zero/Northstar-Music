...
Navigation should keep Queue and Library as distinct top-right views; the now-playing screen should not carry a duplicate queue or floating library control. Side carousel artwork must remain square, tilted, faded, and unlabeled.

**Why:** The user explicitly corrected the navigation hierarchy and artwork proportions after seeing the intermediate layout.

**How to apply:** Keep queue contents inside the Queue view and playlist/search/edit controls inside Library. Use a fixed 1:1 aspect ratio for all cover art, including carousel neighbors.